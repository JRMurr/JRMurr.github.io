...
All this is, is a union type where all types in the union have a field whos value is unique in all the union's types. We can redefine the above types as follows
