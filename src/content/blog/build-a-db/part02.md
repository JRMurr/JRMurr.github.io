...
You can customize the $ B $ constant to have nodes store more/fewer keys and have more/fewer children. The average Lookup for a B-tree with $N$ keys is $\mathcal O(\log_2 N)$ which is the same for a BST.
