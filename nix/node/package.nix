...
let
  sources = {
    ...
    "@giscus/react-3.0.0" = {
      ...
      version = "3.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@giscus/react/-/react-3.0.0.tgz";
    ...
    "kbar-git+ssh://git@github.com/JRMurr/kbar.git#03aab6e0a96c9806cf6a45477b469ca72f2868bf" = {
      name = "kbar";
      packageName = "kbar";
      ...
      src = fetchFromGitHub {
        owner = "JRMurr";
        repo = "kbar";
        rev = "03aab6e0a96c9806cf6a45477b469ca72f2868bf";
        hash = "sha256-vtD/Tgi6NtGxl9Wpb/ApOb2Sb4tohfpbTz/HHQgVNhE=";
      };
    };
    "keyv-4.5.4" = {
      name = "keyv";
    ...
    "terser-5.29.1" = {
      ...
      version = "5.29.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/terser/-/terser-5.29.1.tgz";
        sha512 = "lZQ/fyaIGxsbGxApKmoPTODIzELy3++mXhS5hOqaAWZjQtpq/hFHAc+rm29NND1rYRxRWKcjuARNwULNXa5RtQ==";
      };
    };
    "text-table-0.2.0" = {
      name = "text-table";
    ...
    "velite-0.1.0-beta.12" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/velite/-/velite-0.1.0-beta.12.tgz";
        sha512 = "CsFH+Aan5pDW9j836rmrUVqLb71suUegTefw5JdeADI44IF+qcnIUavfizu/4Dda1rL2a83E0B+hV8jp5GHbhw==";
      };
    };
    "vfile-5.3.7" = {
      name = "vfile";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."kbar-git+ssh://git@github.com/JRMurr/kbar.git#03aab6e0a96c9806cf6a45477b469ca72f2868bf"
      sources."keyv-4.5.4"
