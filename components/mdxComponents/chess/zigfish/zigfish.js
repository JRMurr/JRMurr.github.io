var zigfish = (() => {
  ...
  return function (moduleArg = {}) {
    ...
    var ASM_CONSTS = {
      ...
      324262: () => document.getElementById('canvas').width,
      324314: () => parseInt(document.getElementById('canvas').style.width),
      324382: () => {
      ...
      324528: () => document.getElementById('canvas').width,
      324580: () => screen.width,
      324605: () => {
        document.exitFullscreen()
      },
      ...
      324811: () => document.getElementById('canvas').width,
      324863: () => parseInt(document.getElementById('canvas').style.width),
      324931: () => {
        if (document.fullscreenElement) return 1
      },
      324977: () => document.getElementById('canvas').width,
      325029: () => screen.width,
      325054: () => {
        if (document.fullscreenElement) return 1
      },
      325100: () => document.getElementById('canvas').width,
      325152: () => screen.width,
      325177: () => {
        document.exitFullscreen()
      },
      ...
      325250: () => document.getElementById('canvas').width,
      325302: () => parseInt(document.getElementById('canvas').style.width),
      325370: () => {
        document.exitFullscreen()
      },
      325397: () => screen.width,
      325422: () => screen.height,
      325448: () => window.screenX,
      325475: () => window.screenY,
      325502: ($0) => {
